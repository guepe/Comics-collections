...
def main():
    ...
    parser.add_argument("--db", default="guepe-comics-collections-19-0-32453836", help="Nom de la base de données")
    parser.add_argument("--user", default="admin", help="Login Odoo")
    parser.add_argument("--password", default="admin", help="Mot de passe Odoo")
    parser.add_argument(
        "--publish", action="store_true", help="Forcer la publication sur le web (même si colonne manquante)"
    )
    parser.add_argument("--no-covers", action="store_true", help="Ne pas récupérer les couvertures (plus rapide)")
