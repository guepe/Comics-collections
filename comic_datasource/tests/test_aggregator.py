...
class TestComicDataAggregator(unittest.TestCase):
    ...
    def setUp(self):
        super().setUp()
        from odoo.addons.comic_datasource.aggregator import (  # pylint: disable=odoo-addons-relative-import
            ComicDataAggregator,
        )
    ...
    def test_google_wins_for_synopsis(self):
        google_result = _make_result(
            "google", title="Astérix", synopsis="Synopsis Google", cover_url="http://google/large.jpg"
        )
